...
ActiveRecord::Schema.define(:version => 20140315003358) do
  ...
  create_table "curationusers", :force => true do |t|
    t.string   "name"
    t.string   "email"
  ...
  create_table "keyword_view", :id => false, :force => true do |t|
    t.string "Model_ID", :limit => 45, :default => "", :null => false
    t.text   "Keywords"
  end
  ...
  create_table "sequences", :primary_key => "Attr_Name", :force => true do |t|
    t.integer "Seq_Nbr", :null => false
  end
